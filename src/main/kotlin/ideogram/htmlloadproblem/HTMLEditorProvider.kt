...
import ideogram.htmlloadproblem.HTMLEditorProvider.Companion.JS_FUNCTION_NAME
...
class HTMLEditorProvider : FileEditorProvider, DumbAware {
  ...
  companion object {
    private val REQUEST_KEY: Key<Request> = Key.create("test.html.editor.request.key")
    private val EDITOR_KEY: Key<FileEditor> = Key.create("test.html.editor.component.key")
